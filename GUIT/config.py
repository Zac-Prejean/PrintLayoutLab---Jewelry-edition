...
from mugs_config import (    
    ...
    flip_mug_image, add_order_number_to_jmug
)
...
# Merge dictionaries    
sku_to_image = {**deskplates_sku_to_image, **glfbl_sku_to_image, **mug_sku_to_image, **nck_sku_to_image, **planks_sku_to_image, **tumbler_sku_to_image}    
sku_to_font = {**deskplates_sku_to_font, **glfbl_sku_to_font, **mug_sku_to_font, **planks_sku_to_font, **rng_sku_to_font, **tumbler_sku_to_font}    
sku_to_fontsize_placement = {**deskplates_sku_to_fontsize_placement, **glfbl_sku_to_fontsize_placement, **mug_sku_to_fontsize_placement, **nck_sku_to_fontsize_placement, **planks_sku_to_fontsize_placement, **rng_sku_to_fontsize_placement, **tumbler_sku_to_fontsize_placement}    
sku_to_second_fontsize_placement = {**deskplates_sku_to_second_fontsize_placement, **glfbl_sku_to_second_fontsize_placement, **mug_sku_to_second_fontsize_placement, **planks_sku_to_second_fontsize_placement, **rng_sku_to_second_fontsize_placement, **tumbler_sku_to_second_fontsize_placement}
sku_to_second_line_font = {**deskplates_sku_to_second_line_font, **mug_sku_to_second_line_font, **planks_sku_to_second_line_font, **rng_sku_to_second_line_font, **tumbler_sku_to_second_line_font}
